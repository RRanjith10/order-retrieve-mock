 ...
 *                         &lt;/complexType&gt;
 *                       &lt;/element&gt;
 *                       &lt;element ref="{http://www.iata.org/IATA/EDIST/2017.2}Metadata" minOccurs="0"/&gt;
 *                     &lt;/sequence&gt;
 *                   &lt;/restriction&gt;
 *                 &lt;/complexContent&gt;
 *               &lt;/complexType&gt;
 ...
 *                 &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                   &lt;sequence&gt;
 *                     &lt;element name="Error" type="{http://www.iata.org/IATA/EDIST/2017.2}ErrorType" maxOccurs="unbounded"/&gt;
...
public class OrderViewRS {
    ...
    public static class Response {
        ...
        /**
         * Transaction Processing Results, including processing
         *                                                 status, alerts, notices, business warnings, supplemental marketing
         *                                                 messages and policy.
         * 													
         * 
         * @return
        ...
        public static class DataLists {
            ...
            public static class BaggageAllowanceList {
                ...
                public List<OrderViewRS.Response.DataLists.BaggageAllowanceList.BaggageAllowance> getBaggageAllowance() {
                    if (baggageAllowance == null) {
                        baggageAllowance = new ArrayList<OrderViewRS.Response.DataLists.BaggageAllowanceList.BaggageAllowance>();
                    }
            ...
            public static class DescriptionList {
                 ...
                 * <p>
                 * Objects of the following type(s) are allowed in the list
                 * {@link com.ndc.orderretrieve.Description }
                 * 
                 * 
                 */
            ...
            public static class SeatDefinitionList {
                ...
                public List<OrderViewRS.Response.DataLists.SeatDefinitionList.SeatDefinition> getSeatDefinition() {
                    if (seatDefinition == null) {
                        seatDefinition = new ArrayList<OrderViewRS.Response.DataLists.SeatDefinitionList.SeatDefinition>();
                    }
                ...
                public static class SeatDefinition {
                    ...
                    public List<OrderViewRS.Response.DataLists.SeatDefinitionList.SeatDefinition.Description> getDescription() {
                        if (description == null) {
                            description = new ArrayList<OrderViewRS.Response.DataLists.SeatDefinitionList.SeatDefinition.Description>();
                        }
                        return this.description;
                    }
                    ...
                    public static class Description {
                        ...
                        public List<OrderViewRS.Response.DataLists.SeatDefinitionList.SeatDefinition.Description.Media> getMedia() {
                            if (media == null) {
                                media = new ArrayList<OrderViewRS.Response.DataLists.SeatDefinitionList.SeatDefinition.Description.Media>();
                            }
                            return this.media;
                        }
