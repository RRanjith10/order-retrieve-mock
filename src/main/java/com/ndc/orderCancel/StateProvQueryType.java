 ...
 *                 Feature(s)
 *                 ============
 *                 â€¢ Query by list of State/ Province Codes
 *                 â€¢ Query by list of State/ Province Keywords
 *                 â€¢ Preference Level for all or individual Query ParameterGroups
 *                 â€¢ Proximity information containing either the requested maximum distance search radius values, or the
 *                 actual Proximity information (which is typically used to specify the results from the named location
 *                 radius search.)
 * 
 *                 ============
 *                 Metadata
