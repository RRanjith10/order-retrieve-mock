 ...
 *                 â€¢ Plain Text
 *                 â€¢ Marked-Up Text
 *                 â€¢ Rich Media Object ID and/ or URL to Source (e.g. images and streaming video)
 *                 ============
 *                 ====
 *                 Feature(s)
 * 
 *                 a) Rendering Instructions, for converting an attachment into a specified display format, may be included
 *                 with Media Attachments.
 *                 3. Metadata: Yes
 * 
 *                 2. Rendering Instructions, for converting an attachment into a specified display format, may be included
 *                 with Media Attachments.
 * 
 *                 3. These capabilities may not be supported by all NDC-enabled systems or may be supported by bilateral
 *                 agreement only. If supported, the technical implementation of this capability is not dictated by this
 *                 specification.
 *             
 * 
...
@XmlSeeAlso({
    com.ndc.orderCancel.MarketingMessages.MarketMessage.class,
    com.ndc.orderCancel.MarketingInfoType.Message.class,
    com.ndc.orderCancel.ServiceDescriptionType.Description.class,
    com.ndc.orderCancel.Description.class
})
