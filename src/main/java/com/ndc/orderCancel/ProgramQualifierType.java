...
public class ProgramQualifierType {
     ...
     *                         Notes:
     *                         1. Supports pricing discounts and/ or other benefits from membership in Travel Discount
     *                         Programs, such as AARP and AAA.
     *                         2. Discount Programs may be associated to individual Travellers but will apply to ALL Travellers
     *                         if no associations are specified.
     *                     
     * 
     * @return
     *     possible object is
