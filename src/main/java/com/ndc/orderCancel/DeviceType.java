...
@XmlSeeAlso({
    com.ndc.orderCancel.SecurePaymentAlertType.Details.CustomerDevice.class,
    com.ndc.orderCancel.PinPhraseAnswerType.Device.class,
    com.ndc.orderCancel.PinPhraseQuestionType.Device.class
})
public class DeviceType {
    ...
    /**
     * Provides telephone information, and allows to specify telephone number
     *                         application (ie Home, Business, etc.). May be used for a simle, unstrucutured number, or, in
     *                         combination with child attributes allows to create a structured telephone number (ie Country
     *                         Code number, Area Code numbers, etc.)
     *                     
     * 
     * @return
     *     possible object is
