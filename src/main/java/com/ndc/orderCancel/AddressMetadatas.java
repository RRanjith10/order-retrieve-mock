 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.iata.org/IATA/EDIST/2017.2}AddressMetadata" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "AddressMetadatas")
public class AddressMetadatas {

    @XmlElement(name = "AddressMetadata", required = true)
    protected List<AddressMetadataType> addressMetadata;

    /**
     * ADDRESS Metadata.Gets the value of the addressMetadata property.
     * 
     * <p>
