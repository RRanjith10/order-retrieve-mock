...
/**
 * 
 *                 Acceptable Price Variance Rule definition. Note: This is the acceptable amount and/or percentage of the
 *                 total amount by which the Order item price can vary from the Offer price for Order creation to proceed,
 *                 for example to cover minor currency exchange rate fluctuations for taxes quoted in a different currency.
 *             
 * 
    ...
    extends TrxProcessObjectBaseType
{
    ...
    public static class Results {
        ...
        public static class PriceVariance {
            ...
            /**
             * 
             *                                                         Order ID, Order Item and other associations where a price
