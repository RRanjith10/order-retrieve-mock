...
@XmlSeeAlso({
    com.ndc.orderCancel.BookingReferenceType.AirlineID.class,
    com.ndc.orderCancel.SecurePaymentPaxInfoType.Carriers.Carrier.class,
    com.ndc.orderCancel.CarrierFeeInfoType.CarrierFees.Fee.AirlineID.class,
    com.ndc.orderCancel.AirlineID.class
})
