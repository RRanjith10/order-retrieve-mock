...
/**
 * 
 *                 Optional Service Filter Notification. Note: Supports ATPCO group and subgroup code(s) that specify the
 *                 requested categories of Optional Services to be returned in the results.
 *             
 * 
