 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.iata.org/IATA/EDIST/2017.2}FlightMetadata" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class FlightMetadatas {
     ...
     * This is why there is not a <CODE>set</CODE> method for the flightMetadata property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getFlightMetadata().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<FlightMetadata> getFlightMetadata() {
        if (flightMetadata == null) {
            flightMetadata = new ArrayList<FlightMetadata>();
        }
