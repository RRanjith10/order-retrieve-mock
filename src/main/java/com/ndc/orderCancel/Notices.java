...
public class Notices {
    ...
    public static class Notice {
        ...
        /**
         * Price Variance Rule(s) Notice. Note: Supports specifying Payment
         *                                         Processing Rules, including payment failure. Request messages may include
         *                                         defined payment processing rules and an indicator requesting that the rules be
         *                                         applied during payment processing where relevant. Response messages may
         *                                         additionally include notice about if and how payment rule(s) were applied during
