...
/**
 * A data type for OPERATING CARRIER Supplier Role with
...
@XmlSeeAlso({
    com.ndc.orderCancel.ListOfFlightSegmentType.OperatingCarrier.class,
    com.ndc.orderCancel.FlightOnlyType.OperatingCarrier.class,
    com.ndc.orderCancel.FlightType.Flight.OperatingCarrier.class,
    com.ndc.orderCancel.CouponSoldAirlineType.OperatingCarrier.class,
    com.ndc.orderCancel.CouponFlightSegmentType.OperatingCarrier.class
})
public class OperatingCarrierFlightType {
    ...
    /**
     * A two-character alpha-numeric code assigned according to the IATA Resolution 762
     *                         or a three-letter airline designator assigned by ICAO. Refer to IATA Airline Coding Directory.
     *                     
     * 
     * @return
     *     possible object is
