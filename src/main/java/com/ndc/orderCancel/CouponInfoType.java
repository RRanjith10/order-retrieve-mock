...
public class CouponInfoType {
    ...
    /**
     * Association to services paid by the EMD Association to multiple Optional Service
     *                         instance(s). Example: srvc1 srvc2
    ...
    /**
     * In connection with document number (A document number representing a transaction
     *                         that is issued in relation to this transaction); and coupon number (the coupon number(s)
     *                         associated with the 'in connection with' document number.)
     *                     
     * 
     * @return
     *     possible object is
