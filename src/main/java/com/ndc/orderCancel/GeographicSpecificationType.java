...
public class GeographicSpecificationType {
     ...
     *                         specifications. Users may enter a location here which is further defined by the @Type. Valid
     *                         area values include 1 = Western Hemisphere 2 = Europe, Africa, and the Near East 3 = Far East,
     *                         Australia, and Pacific Valid sub areas are Standard ISO/IATA sub area code Valid airport and
     *                         city codes are a three letter location identifier assigned according to the IATA Resolution 763.
     *                         Refer to IATA Airline Coding Directory . Example: TPA
